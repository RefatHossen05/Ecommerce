...
<h1 class="text-center p-2">Updated Category form</h1>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <form action="{{route('subcategory.update',$subcategories->id)}}" method="post">
                ...
                <input type="text" class="form-control" name="subcategory_name" placeholder="" id="subcategory" value="{{$subcategories->subcategory_name}}">
                </div>
